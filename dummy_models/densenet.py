...
trainset = torchvision.datasets.CIFAR10(
    root='/home/austin/Documents/Datasets/CIFAR10', train=True, download=False, transform=transform_train)

validset = torchvision.datasets.CIFAR10(
    root='/home/austin/Documents/Datasets/CIFAR10', train=True, download=False, transform=transform_validation)

testset = torchvision.datasets.CIFAR10(
    root='/home/austin/Documents/Datasets/CIFAR10', train=False, download=False, transform=transform_test)
...
net = DenseNetBC_250_24()
net.to(device)

# === summarized net architecture ===
